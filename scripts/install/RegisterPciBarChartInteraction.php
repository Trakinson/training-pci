 ...
 *
 * Usage:
 * sudo -u www-data php index.php '\oat\trainingPci\scripts\install\RegisterPciBarChartInteraction'
 *
 * @package oat\trainingPci\scripts\install
 */
class RegisterPciBarChartInteraction extends RegisterPortableElement
{
    protected function getSourceDirectory(){
        $viewDir = \common_ext_ExtensionsManager::singleton()->getExtensionById('trainingPci')->getConstant('DIR_VIEWS');
        return $viewDir.implode(DIRECTORY_SEPARATOR, ['js', 'pciCreator', 'barChartInteraction']);
    }
}
