define([
    ...
    'tpl!barChartInteraction/creator/tpl/propertiesForm',
    'tpl!taoQtiItem/qtiCreator/tpl/notifications/widgetOverlay'
], function(stateFactory, Question, formElement, formTpl, overlayTpl){

    var BarChartInteractionStateQuestion = stateFactory.extend(Question, function(){
    ...
    BarChartInteractionStateQuestion.prototype.initForm = function(){
    ...
    return BarChartInteractionStateQuestion;
});
